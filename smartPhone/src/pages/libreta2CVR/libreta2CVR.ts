...
export class Libreta2CVRPage {
  ...
  funciones=[];
  constructor(public alertCtrl:AlertController,private storage: Storage,public events:Events,public httpClient:HttpClient,public file:File,public http:HTTP,public navCtrl: NavController, public navParams:NavParams) {
