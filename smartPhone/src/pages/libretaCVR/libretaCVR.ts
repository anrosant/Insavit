...
export class LibretaCVRPage {
    ...
    constructor(private storage: Storage, public platform: Platform, private toastCtrl: ToastController,
                public menuCtrl:MenuController, public httpClient:HttpClient, public file:File,
    ...
    clickNextPage(item2,indexCategoria,indexSubCategoria) {
        ...
        this.navCtrl.push(LibretaCVRPage,param);
    }
