...
export class PerfilPage {
  ...
  libretasEnviadas;
  fechaInstalacion;
  usuario={usuario:'cbenitez',session:true,data:{"codigo_estacion":"M0123","id_estacion":63765,"latitud":"-1.133889","longitud":"-79.075556","altura":"1471.00","provincia":"COTOPAXI","canton":"PANGUA","parroquia":"EL CORAZON","usuario":"juan","rol":"Libretas principales"}};

  constructor(private geolocation: Geolocation,private storage: Storage, public navCtrl: NavController,public navParams:NavParams, public alertCtrl: AlertController) {
    ...
    this.storage.get('libretasEnviadas').then((val) => {
          ...
          console.log('enviadassssssssssss');
          console.log(val);
